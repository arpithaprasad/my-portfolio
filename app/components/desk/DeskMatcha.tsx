...
export default function DeskMatcha() {
  ...
  return (
    <motion.div
      className="group absolute left-[2%] top-[58%] z-[25] w-[18%] max-w-[76px] cursor-default"
      initial="rest"
      animate="rest"
    ...
    >
      <motion.div
        className="absolute -top-16 left-1/2 z-30 w-40 -translate-x-1/2 rounded-xl bg-white px-2.5 py-2 text-center shadow-[0_4px_16px_rgba(0,0,0,0.08)]"
        variants={tipVariants}
        transition={spring}
      >
        <p className="text-[10px] leading-snug text-[var(--foreground)]">
          Iced strawberry matcha latte — oat milk, less ice, 50% sugar ✨
        </p>
      ...
      <svg
        viewBox="0 0 60 90"
        className="relative z-0 h-auto w-full drop-shadow-[0_4px_16px_rgba(0,0,0,0.08)]"
      >
        <defs>
